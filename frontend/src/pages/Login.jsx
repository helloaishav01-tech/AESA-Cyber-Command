      ...
      >
        <div className="bg-surface border border-white/10 rounded-lg p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="font-sans text-2xl font-bold tracking-tight mb-1">AESA</h1>
            <p className="text-text-secondary text-xs uppercase tracking-widest">
              Autonomous Enterprise Security Agent
            </p>
          </div>
          ...
          <p className="text-center text-sm text-text-secondary mt-6">
            New to AESA?{" "}
            <Link to="/register" className="text-status-safe hover:underline" data-testid="register-link">
              Create an account
            </Link>
          </p>
        </div>
